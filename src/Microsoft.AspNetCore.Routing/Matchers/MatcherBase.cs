...
namespace Microsoft.AspNetCore.Routing.Matchers
{
    ...
    {
        protected internal abstract void SelectCandidates(HttpContext httpContext, ref CandidateSet candidates);
            ...
            IEndpointFeature feature)
        {
            ...
            for (var i = 0; i < candidates.CandidateGroups.Length; i++)
            {
                ...
                for (var j = offset; j < offset + groupLength; j++)
                {
                    ...
                    var match = true;
                    var index = candidates.CandidateIndices[j];
                    var processors = candidates.Candidates[index].Processors;
                    ...
                    if (match)
                    {
                        feature.Endpoint = candidates.Candidates[index].Endpoint;
